...
def build_zip(predictions_dir, zip_output_name):
    ...
    if not predictions_dir.exists():
        raise FileNotFoundError(
            f"Prediction folder not found: {predictions_dir}\n"
            "Set `predictions_dir` to the folder generated by baseline inference."
        )
    ...
    if not prediction_files:
        ...
        print(f"Found {len(prediction_files)} prediction files to zip in {predictions_dir}.")
